...
cp -R dist/Release32/{d3dcompiler_47.dll,renderdoc.dll,renderdoc.json,zhuadocshim32.dll,zhuadoccmd.exe,dbghelp.dll,symsrv.dll,symsrv.yes} dist/Release64/x86/
mkdir -p dist/ReleasePDBs64/x86
cp -R dist/ReleasePDBs32/{d3dcompiler_47.dll,renderdoc.dll,renderdoc.json,renderdoc.pdb,zhuadocshim32.dll,renderdocshim32.pdb,zhuadoccmd.exe,renderdoccmd.pdb,dbghelp.dll,symsrv.dll,symsrv.yes} dist/ReleasePDBs64/x86/
